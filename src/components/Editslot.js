...
const Editslot = forwardRef((props, ref) => {
  ...
  // onclick for copyToClipboard
  const handleClipboard = () => {
    copyToClipboard("uidinput")
            ...
            <div className="modal-body">
              <form>
                <div className="form-group">
                  {student && student.name && (<p className='mb-3'>Assigned to <span class="mx-1 btn btn-success btn-sm">{student.name}</span></p>)}
                  ...
                  <div className='d-flex align-items-center justify-content-between'>
                    ...
                    <span className='px-1 position-relative' style={{ marginTop: "-17px" }} title='Unassign' role="button" type="button" data-bs-dismiss="modal" onClick={makeSeatAvailable}>
                    ...
                    <span className='position-relative'>
                      <svg xmlns="http://www.w3.org/2000/svg" onClick={handleClipboard} width="20" height="20" fill="currentColor" class="bi bi-copy position-absolute align-middle cursor-pointer" style={{ right: '43px', bottom: '-1px' }} viewBox="0 0 16 16">
